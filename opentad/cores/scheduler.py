...
def build_scheduler_deepspeed(cfg, dataloader_len, accumulation_steps):
    ...
    deepspeed_cfg["params"]["warmup_num_steps"] = int(cfg["warmup_epoch"] * dataloader_len / accumulation_steps)
    deepspeed_cfg["params"]["total_num_steps"] = int(max_epoch * dataloader_len / accumulation_steps)
    return deepspeed_cfg, max_epoch
...
def build_scheduler(cfg, optimizer, dataloader_len):
    ...
    if scheduler_type == "LinearWarmupCosineAnnealingLR" or scheduler_type == "WarmupCosineLR":
