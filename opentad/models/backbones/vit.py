...
class VisionTransformerCP(BaseModule):
    ...
    def __init__(
        ...
        self.norm = nn.Identity() if use_mean_pooling else build_norm_layer(norm_cfg, embed_dims)[1]
        self.fc_norm = build_norm_layer(norm_cfg, embed_dims)[1] if use_mean_pooling else None
...
class VisionTransformerCP_Small(VisionTransformerCP):
    def __init__(self):
        super().__init__(
            img_size=224,
            patch_size=16,
...
class VisionTransformerCP_Base(VisionTransformerCP):
    def __init__(self):
        super().__init__(
            img_size=224,
            patch_size=16,
...
class VisionTransformerCP_Large(VisionTransformerCP):
    def __init__(self):
        super().__init__(
            img_size=224,
            patch_size=16,
